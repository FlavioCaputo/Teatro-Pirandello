...
function Alfieri(hotSpotDiv, args) {
  ...
  testo.textContent = "Vittorio Alfieri fù un celebre drammaturgo, poeta e scrittore italiano del XVIII secolo. Il dipinto di forma circolare, impreziosito da un elegante profilo dorato e da una cornice in stucco di colore bianco.";
...
function Goldoni(hotSpotDiv, args) {
  ...
  var testo = document.createElement('p');
  testo.textContent = "Carlo Goldoni fù un celebre compositore italiano considerato uno dei padri della commedia moderna. Il dipinto di forma circolare, impreziosito da un elegante profilo dorato e da una cornice in stucco di colore bianco.";
  testo.classList.add('text');
  var x = document.createElement('p');
  x.classList.add('text-x');
  x.textContent = "x";
...
function Metastasio(hotSpotDiv, args) {
  ...
  var testo = document.createElement('p');
  testo.textContent = "Pietro Trapassi, meglio conosciuto come Metastasio fù un celebre poeta, librettista, drammaturgo del XVIII. Il dipinto di forma circolare, impreziosito da un elegante profilo dorato e da una cornice in stucco di colore bianco.";
  testo.classList.add('text');
  var x = document.createElement('p');
  x.classList.add('text-x');
  x.textContent = "x";
